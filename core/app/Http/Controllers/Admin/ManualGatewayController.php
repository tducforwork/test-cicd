...
class ManualGatewayController extends Controller
{
    ...
    {
        $pageTitle = __('Add Manual Gateway');
    ...
    public function store(Request $request)
    {
        ...
        $notify[] = ['success', $method->name . ' ' . __('Manual gateway has been added.')];
        return back()->withNotify($notify);
    }

    public function edit($alias)
    {
        $pageTitle = __('Edit Manual Gateway');
    ...
    public function update(Request $request, $code)
    {
        ...
        $notify[] = ['success', $method->name . ' ' . __('manual gateway updated successfully')];
