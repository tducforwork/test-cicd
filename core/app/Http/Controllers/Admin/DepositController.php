...
class DepositController extends Controller
{
    ...
    {
        $pageTitle = __('Approved Payments');
    ...
    {
        $pageTitle = __('Successful Payments');
    ...
    {
        $pageTitle = __('Rejected Payments');
    ...
    {
        $pageTitle = __('Initiated Payments');
    ...
    public function details($id)
    {
        ...
        $pageTitle = $deposit->user->username . ' ' . __('requested') . ' ' . showAmount($deposit->amount);
