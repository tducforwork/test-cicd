...
class NotificationController extends Controller
{
    public function globalEmail(){
        $pageTitle = __('Global Email Template');
    ...
    public function globalEmailUpdate(Request $request){
        ...
        $notify[] = ['success',__('Global email template updated successfully')];
        return back()->withNotify($notify);
    }

    public function globalSms(){
        $pageTitle = __('Global Sms Template');
    ...
    public function globalSmsUpdate(Request $request){
        ...
        $notify[] = ['success',__('Global sms template updated successfully')];
        return back()->withNotify($notify);
    }

    public function globalPush(){
        $pageTitle = __('Global Push Notification Template');
    ...
    public function globalPushUpdate(Request $request){
        ...
        $notify[] = ['success',__('Global push notification template updated successfully')];
        return back()->withNotify($notify);
    }

    public function templates(){
        $pageTitle = __('Notification Templates');
    ...
    public function emailSetting(){
        $pageTitle = __('Email Notification Settings');
    ...
    public function emailSettingUpdate(Request $request)
    {
        $request->validate([
            ...
            'host.required_if' => __('The :attribute is required for SMTP configuration'),
            'port.required_if' => __('The :attribute is required for SMTP configuration'),
            'username.required_if' => __('The :attribute is required for SMTP configuration'),
            'password.required_if' => __('The :attribute is required for SMTP configuration'),
            'enc.required_if' => __('The :attribute is required for SMTP configuration'),
            'appkey.required_if' => __('The :attribute is required for SendGrid configuration'),
            'public_key.required_if' => __('The :attribute is required for Mailjet configuration'),
            'secret_key.required_if' => __('The :attribute is required for Mailjet configuration'),
        ]);
    ...
    public function emailTest(Request $request){
       ...
       if (session('mail_error')) {
           ...
           $notify[] = ['success', __('Email sent to') . ' ' . $request->email . ' ' . __('successfully')];
       }
   ...
   public  function smsSetting(){
        $pageTitle = __('SMS Notification Settings');
    ...
    public function smsTest(Request $request){
        ...
        if (session('sms_error')) {
            ...
            $notify[] = ['success', __('SMS sent to') . ' ' . $request->mobile . ' ' . __('successfully')];
        }
    ...
    {
        $pageTitle = __('Push Notification Settings');
    ...
    public function pushSettingUpload(Request $request){
        ...
        $notify[] = ['success', __('Configuration file uploaded successfully')];
        return back()->withNotify($notify);
    }
    public function pushSettingDownload()
    {
        ...
        if (!file_exists($filePath)) {
            $notify[] = ['success', __("File not found")];
            return back()->withNotify($notify);
        }
