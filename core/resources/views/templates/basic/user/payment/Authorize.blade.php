                            ...
                            <form role="form" class="disableSubmission appPayment" id="payment-form" method="{{ $data->method }}" action="{{ $data->url }}">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="text" class="form-control form--control" name="name" id="name" value="{{ old('name') }}" required autocomplete="off" autofocus />
                                    ...
                                    <div class="col-md-6">
                                        ...
                                        <div class="input-group">
                                            <input type="tel" class="form-control form--control" name="cardNumber" id="cardNumber" autocomplete="off" value="{{ old('cardNumber') }}" required autofocus />
                                ...
                                <div class="row mt-4">
                                    <div class="col-md-6">
                                        ...
                                        <input type="tel" class="form-control form--control" name="cardExpiry" id="cardExpiry" value="{{ old('cardExpiry') }}" autocomplete="off" required />
                                    </div>
                                    <div class="col-md-6 ">
                                        <label class="form-label" for="cardCVC">@lang('CVC Code')</label>
                                        <input type="tel" class="form-control form--control" name="cardCVC" id="cardCVC" value="{{ old('cardCVC') }}" autocomplete="off" required />
                                    </div>
                                </div>
                                <br>
