...
<div class="account-section padding-bottom padding-top">
    <div class="contact-thumb d-none d-lg-block">
        <img src="{{ getImage('assets/images/frontend/reset_password_page/'. @$content->data_values->image, '600x600') }}" alt="@lang('login-bg')">
    </div>
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-7">
                ...
                <form method="POST" action="{{ route('seller.password.update') }}" class="contact-form mb-30-none">
                    @csrf
                    ...
                    <div class="contact-group">
                        <div class="m--10 d-flex flex-wrap align-items-center w-100 justify-content-between">
                            <span class="account-alt"><a href="{{ route('seller.login') }}">@lang('Login')</a></span>
