                ...
                <div class="flex-1 min-w-0">
                    <div class="max-w-[1320px] mx-auto">
                        ...
                        <form id="jobForm" action="{{ route('seller.jobs.store', @$job->id) }}" method="POST"
                            ...
                            <!-- I. Thông tin việc làm -->
                            <div class="bg-white rounded-[12px] p-6 border border-gray-100">
                                <h2 class="text-xl font-bold text-[#272343] mb-6">@lang('I. Thông tin việc làm')</h2>

                                <div class="space-y-6">
                                    <!-- Tiêu đề -->
                                    <div>
                                        <label class="text-[16px] font-normal text-[#272343] leading-relaxed mb-2 block">
                                            @lang('Tiêu đề công việc') <span class="text-danger">*</span>
                                        </label>
                                        <input type="text" name="title"
                                            ...
                                            placeholder="@lang('Ví dụ: Tuyển Nhân viên kinh doanh BĐS')"
                                    ...
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div>
                                            <label
                                                ...
                                                @lang('Ngành nghề') <span class="text-danger">*</span>
                                            </label>
                                        ...
                                        <div>
                                            <label
                                                class="text-[16px] font-normal text-[#272343] leading-relaxed mb-2 block">
                                                @lang('Cấp bậc') <span class="text-danger">*</span>
                                            </label>
                                    ...
                                    <div>
                                        <label class="text-[16px] font-normal text-[#272343] leading-relaxed mb-2 block">
                                            @lang('Mô tả công việc') <span class="text-danger">*</span>
                                        </label>
                            ...
                            <!-- II. Thông tin công ty & Địa điểm -->
                            <div class="bg-white rounded-[12px] p-6 border border-gray-100">
                                <h2 class="text-xl font-bold text-[#272343] mb-6">@lang('II. Công ty & Địa điểm')</h2>
                                ...
                                <div class="space-y-6">
                                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div>
                                            <label
                                                class="text-[16px] font-normal text-[#272343] leading-relaxed mb-2 block">
                                                @lang('Tên công ty/ Cửa hàng') <span class="text-danger">*</span>
                                            </label>
                                        ...
                                        <div>
                                            <label
                                                class="text-[16px] font-normal text-[#272343] leading-relaxed mb-2 block">@lang('Logo công ty')</label>
                                            <label for="logoInput"
                                        ...
                                        <div class="md:col-span-2">
                                            <label
                                                class="text-[16px] font-normal text-[#272343] leading-relaxed mb-2 block">@lang('Hình ảnh minh họa (Nhiều ảnh)')</label>
                            ...
                            <!-- III. Lương & Hạn nộp -->
                            <div class="bg-white rounded-[12px] p-6 border border-gray-100">
                                <h2 class="text-xl font-bold text-[#272343] mb-6">@lang('III. Lương & Hạn nộp')</h2>

                                <div class="space-y-6">
                                    <div>
                                        <label
                                            class="text-[16px] font-normal text-[#272343] leading-relaxed mb-2 block">@lang('Mức lương')</label>
                                        <select name="salary_type" class="select2 rounded-[6px] h-[49px]" id="salaryType">
                                            <option value="negotiable" @selected(old('salary_type', @$job->salary_type) == 'negotiable')>@lang('Thỏa thuận')</option>
                                            <option value="range" @selected(old('salary_type', @$job->salary_type) == 'range')>@lang('Khoảng lương')</option>
                                        </select>
                                    </div>

                                    <div class="salary-input grid grid-cols-1 md:grid-cols-2 gap-4 hidden">
                                        <div>
                                            <label class="text-sm text-gray-500 mb-1 block">@lang('Lương từ')</label>
                                            <input type="number" name="salary_from"
                                                class="w-full h-[49px] px-4 rounded-[6px] border border-[#E6E6E6] bg-white text-[#272343] text-[16px] focus:outline-none focus:ring-1 focus:ring-kviet-orange"
                                                value="{{ old('salary_from', @$job->salary_from) }}" min="0">
                                        </div>
                                        <div>
                                            <label class="text-sm text-gray-500 mb-1 block">@lang('Lương đến')</label>
                                            <input type="number" name="salary_to"
                                                class="w-full h-[49px] px-4 rounded-[6px] border border-[#E6E6E6] bg-white text-[#272343] text-[16px] focus:outline-none focus:ring-1 focus:ring-kviet-orange"
                                                value="{{ old('salary_to', @$job->salary_to) }}" min="0">
                                        </div>
                                    </div>
