                ...
                <form method="POST">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            <label>@lang('Contact Notification Receiver Email')</label>
                            <input type="email" name="contact_email" class="form-control" value="{{ gs('contact_email') }}">
                            <small class="text--info"><i class="las la-info-circle"></i> @lang('All contact messages from the website will be sent to this email address.')</small>
                        </div>
                        <div class="form-group">
