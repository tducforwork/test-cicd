...
@section('panel')
    <div class="row mb-none-30">
                ...
                <div class="card-body">
                    ...
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Username')
                            <span class="fw-bold">
                                <a href="{{ route('admin.sellers.detail', $withdrawal->seller_id) }}"><span>@</span>{{ @$withdrawal->seller->username }}</a>
                            </span>
                        </li>
                        <li class="list-group-item d-flex justify-content-between align-items-center">
                            @lang('Method')
        ...
        <div class="col-lg-8 col-md-8 mb-30">
            ...
            <div class="card overflow-hidden box--shadow1">
                <div class="card-body">
                    <h5 class="card-title border-bottom pb-2">@lang('Seller Withdraw Information')</h5>
