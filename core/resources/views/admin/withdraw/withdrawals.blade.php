                            ...
                            <tbody>
                                @forelse($withdrawals as $withdraw)
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <span class="fw-bold">{{ $withdraw->seller->fullname }}</span>
                                            <br>
                                            <span class="small"> <a href="{{ appendQuery('search', @$withdraw->seller->username) }}"><span>@</span>{{ $withdraw->seller->username }}</a> </span>
