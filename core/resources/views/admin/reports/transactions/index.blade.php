...
@section('panel')
    @push('topBar')
        @include('admin.reports.transactions.top_bar')
    @endpush
    <div class="row">
                    ...
                    <div class="table-responsive--sm table-responsive">
                        <table class="table table--light style--two">
                            <thead>
                                <tr>
                                    <th>
                                        @if (Route::is('admin.report.user.transaction'))
                                            @lang('User')
                                        @else
                                            @lang('Seller')
                                        @endif
                                ...
                                @forelse($transactions as $trx)
                                    <tr>
                                        <td>
                                            ...
                                            @else
                                                <span class="fw-bold">{{ $trx->seller->fullname }}</span>
                                                <br>
                                                <span class="small"> <a href="{{ appendQuery('search', $trx->seller->username) }}"><span>@</span>{{ $trx->seller->username }}</a> </span>
                                            @endif
                                        </td>
