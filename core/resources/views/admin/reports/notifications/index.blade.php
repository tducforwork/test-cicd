...
@section('panel')
    @push('topBar')
        @include('admin.reports.notifications.top_bar')
    @endpush
    <div class="row">
        <div class="col-lg-12">
            <div class="card">
    ...
    @push('breadcrumb-plugins')
        ...
        @elseif(@$seller)
            <a href="{{ route('admin.sellers.notification.single', $seller->id) }}" class="btn btn-outline--primary btn-sm"><i class="las la-paper-plane"></i> @lang('Send Notification')</a>
        @else
