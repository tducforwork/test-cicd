                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <span class="input-group-text discount-label">{{ gs('cur_text') }}</span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    ...
                                    <input type="text" name="start_date" id="start_date" class="form-control" value="{{ old('start_date') }}" autocomplete="off" required>
                                </div>
                            </div>
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label>@lang('End Date')</label>
                                    <input type="text" name="end_date" id="end_date" class="form-control" value="{{ old('end_date') }}" autocomplete="off" required>
                                </div>
                            </div>
                        </div>
            ...
            function formatProduct(product) {
                ...
                var $container = $(
                    "<div class='select2-result-product d-flex align-items-center'>" +
                        "<div class='select2-result-product__avatar me-2'><img src='" + product.image + "' style='width:40px; height:40px; object-fit:cover; border-radius:4px;' /></div>" +
                    ...
                    <tr class="product-row">
                        <td>
                            <div class="customer-details d-block">
                                <span class="thumb me-2"><img src="${product.image}" alt="image" style="width:40px; height:40px; border-radius:4px;"></span>
