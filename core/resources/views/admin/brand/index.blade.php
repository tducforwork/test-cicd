                            ...
                            <tbody class="list">
                                @forelse($brands as $brand)
                                    <tr>
                                        ...
                                        <td>
                                            <a
                                                href="{{ route('admin.products.all') }}?brand_id={{ $brand->id }}">{{ $brand->products_count }}</a>
                                        </td>

                                        <td>
                                            <x-toggle-switch class="change_status" :checked="$brand->top"
                                                data-id="{{ $brand->id }}" />
                                        </td>
                                        ...
                                        <td>
                                            <div class="button--group">
                                                ...
                                                @if (!Route::is('admin.brand.trashed'))
                                                    <button type="button" class="btn btn-sm btn-outline--primary cuModalBtn editBtn"
                                                ...
                                                @if (!$trashed)
                                                    <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn"
                                                        data-action="{{ route('admin.brand.delete', $brand->id) }}"
                                                        data-question="@lang('Are you sure to delete this brand?')"><i
                                                            class="las la-trash-alt"></i>@lang('Delete')
                                                    </button>
                                                @else
                                                    <button type="button" class="btn btn-sm btn-outline--danger confirmationBtn"
                                                        data-action="{{ route('admin.brand.delete', $brand->id) }}"
                                                        data-question="@lang('Are you sure to restore this brand?')"><i
                                                            class="las la-trash-restore"></i>@lang('Restore')
                                                    </button>
                                                @endif
                                            </div>
                                        </td>
                    ...
                    <form action="{{ route('admin.brand.store') }}" method="POST" enctype="multipart/form-data"
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-9 col-lg-8">
                                ...
                                <div class="form-group row">
                                    <div class="col-lg-3 col-xl-2">
                                        <label>@lang('Icon (Class/URL)')</label>
                                    </div>
                                    <div class="col-lg-9 col-xl-10">
                            ...
                            <div class="col-12">
                                <button type="submit" class="btn btn--primary w-100 h-45"
                                    form="brandForm">@lang('Submit')</button>
                            </div>
                        </div>
                    </form>
                </div>
...
@push('breadcrumb-plugins')
    <div class="d-flex justify-content-end align-items-center flex-wrap gap-2 has-search-form">
        ...
        @if (!$trashed)
            <button type="button" class="btn btn-sm btn-outline--primary h-45 cuModalBtn flex-shrink-0 flex-grow-1 addBtn"
                data-modal_title="@lang('Add New Brand')" data-default_image="{{ getImage(null, getFileSize('brand')) }}">
