...
<div class="row mb-4">
    <div class="col-md-12">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('admin.manage.pages.update') }}" method="POST">
                    @csrf
    ...
    <div class="col-6 col-lg-6 col-xl-8">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <form action="{{ route('admin.manage.pages.builder.update', $pData->id) }}" method="post">
                    @csrf
        ...
        $('[name=slug]').on('input', function() {
            ...
            if (slug) {
                ...
                $('.slug-verification').html(`
                    ...
                    `);
                $.get("{{ route('admin.manage.pages.check.slug',$pData->id) }}", {
                    slug: slug
                }, function(response) {
                    if (!response.exists) {
                        $('.slug-verification').html(`
...
<x-back route="{{ route('admin.manage.pages.index') }}" />
@endpush
