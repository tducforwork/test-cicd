            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="d-flex flex-wrap justify-content-end mt-3">
                        ...
                        <button class="btn btn-outline--success confirmationBtn" data-question="@lang('Are you sure to approve this documents?')" data-action="{{ route('admin.sellers.kyc.approve', $seller->id) }}"><i class="las la-check"></i>@lang('Approve')</button>
                    </div>
                    @endif
                </div>
            </div>
    ...
    <div id="kycRejectionModal" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.sellers.kyc.reject', $seller->id) }}" method="POST">
                    @csrf
