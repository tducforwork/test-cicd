            ...
            <div class="card-body">
                <form method="POST">
                    ...
                    <div class="row">
                        ...
                        <div class="col-xl-3 col-sm-6">
                            <div class="form-group">
                                <label>@lang('Seller Registration Fee')</label>
                                <div class="input-group">
                                    <input type="number" step="any" class="form-control" name="seller_registration_fee" value="{{ getAmount(gs('seller_registration_fee')) }}">
                        ...
                        <div class="col-xl-3 col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="hotline" value="{{ gs('hotline') }}">
                            </div>
                        </div>

                        <div class="col-xl-3 col-sm-6">
                            <div class="form-group">
                                <label>@lang('Support Phone (Zalo)')</label>
                                <input class="form-control" type="text" name="support_phone" value="{{ gs('support_phone') }}">
                            </div>
                        </div>
                        ...
                        <div class="col-xl-3 col-sm-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" type="text" name="address" value="{{ gs('address') }}">
                            </div>
                        </div>
                    </div>
