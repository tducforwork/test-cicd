                    ...
                    <form method="POST" enctype="multipart/form-data">
                        ...
                        <div class="row justify-content-center">
                            <div class="form-group col-md-4 col-sm-6">
                                ...
                                <x-image-uploader name="logo_dark" :imagePath="siteLogo('dark') . '?' . time()" class="w-100" id="logoDark" :required="false" :hasSize="false"/>
                            </div>
                            <div class="form-group col-md-4 col-sm-6">
                                <label> @lang('Logo for Dark Background')</label>
                                <x-image-uploader name="logo" :imagePath="siteLogo() . '?' . time()" class="w-100" id="logo" :required="false" :darkMode="true" :hasSize="false"/>
                            </div>
                            <div class="form-group col-md-4 col-sm-6">
                                <label> @lang('Favicon')</label>
                                <x-image-uploader name="favicon" :imagePath="siteFavicon() . '?' . time()" class="w-100" id="uploadFavicon" :required="false" :hasSize="false"/>
                            </div>
                        </div>
