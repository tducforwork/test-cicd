            ...
            <form method="post">
                ...
                <div class="card-body">
                    <ul class="list-group">
                        ...
                        <li class="list-group-item d-flex flex-wrap flex-sm-nowrap gap-2 justify-content-between align-items-center">
                            <div>
                                <p class="fw-bold mb-0">@lang('Product Auto Approval')</p>
                                <p class="mb-0">
                                    <small>@lang('If you enable this module, the product will be approved when the seller adds a new product; otherwise, it will remain pending.')</small>
                                </p>
                            </div>
                            <div class="form-group">
                                <input type="checkbox" data-width="100%" data-size="large" data-onstyle="-success" data-offstyle="-danger" data-bs-toggle="toggle" data-height="35" data-on="@lang('Enable')" data-off="@lang('Disable')" name="product_auto_approval" @if(gs('product_auto_approval')) checked @endif>
                            </div>
                        </li>
