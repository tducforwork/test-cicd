    ...
    <div class="row gy-4">
        <div class="col-12">
            <div class="row gy-4">
                ...
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="6" link="{{route('admin.order.all')}}" icon="las la-list" title="All Orders"
                        value="{{$widget['all_orders']}}" bg="orange" />
                </div><!-- dashboard-w1 end -->
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="6" link="{{route('admin.order.delivered')}}" icon="las la-cart-arrow-down"
                        title="Total Delivered Order" value="{{$widget['delivered_orders']}}" bg="pink" />
                </div><!-- dashboard-w1 end -->
            </div><!-- row end-->
        </div>
        ...
        <div class="col-12">
            <div class="row gy-4">
                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="1" link="{{route('admin.sellers.all')}}" icon="las la-user-tie" title="Total Sellers"
                        value="{{$widget['total_seller']}}" bg="primary" />
                </div>

                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="1" link="{{route('admin.sellers.active')}}" icon="las la-user-check"
                        title="Active Sellers" value="{{$widget['total_active_seller']}}" bg="success" />
                </div>

                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="1" link="{{route('admin.products.all')}}" icon="las la-box" title="Total Products"
                        value="{{$widget['total_product']}}" bg="dark" />
                </div>

                <div class="col-xxl-3 col-sm-6">
                    <x-widget style="1" link="{{route('admin.deposit.list')}}" icon="las la-file-invoice-dollar"
                            ...
                            <div class="widget-card-wrapper">
                                <div class="widget-card bg--success">
                                    ...
                                    <div class="widget-card-left">
                                        ...
                                        <div class="widget-card-content">
                                            <h6 class="widget-card-amount">
                                                {{ showAmount($withdrawals['total_withdraw_amount']) }}
                                            </h6>
                                ...
                                <div class="widget-card bg--danger">
                                    ...
                                    <div class="widget-card-left">
                                        ...
                                        <div class="widget-card-content">
                                            <h6 class="widget-card-amount">{{ $withdrawals['total_withdraw_rejected'] }}
                                            </h6>
                                ...
                                <div class="widget-card bg--primary">
                                    ...
                                    <div class="widget-card-left">
                                        ...
                                        <div class="widget-card-content">
                                            <h6 class="widget-card-amount">
                                                {{ showAmount($withdrawals['total_withdraw_charge']) }}
                                            </h6>
